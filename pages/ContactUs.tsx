        ...
        <div style={{ backgroundColor: '#abdbe3'}}>
            ...
            <div ><br /><br /><br />
                ...
                <div className='contact' style={{ color: 'black', fontSize: 18 }}>
                    ...
                    <Callout className="bp3-intent-primary">
                        <span style={{ fontSize: "21px" }}>
                            <p style={{ paddingTop:'1%',paddingLeft: '10%' }}>Student Union Office Address:</p>
                            <p style={{ paddingTop: '1%', paddingLeft: '10%' }}> <a href='https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.google.com%2Fmaps%2Fdir%2F%3Fapi%3D1%26destination%3D22.378734366722%252C114.21173383326%26fbclid%3DIwAR1nEKeb0mL7yaQHX4EVnwA9Js7jkPMRQ-_yXMQCHIuPNLHCMKhgFpFLmBI&h=AT2F82GBoBBH0u0VBsCvcyjedzpik1WrLIBt7SPiCmt6bmwwm4-CBEVO4rVoo0xfbRSfQVfrMMhIpfYkbc9yMg-pYU4LxsqVRgLo_npPHuctr_8MIoKmB4ZPjc9c5iqiXUXn8tZ3YSs'>
                            ...
                            <p style={{ paddingTop: '1%', paddingLeft: '10%' }}>中文地址：香港新界沙田小瀝源行善里香港恒生大學B座李兆基綜合大樓3樓303室</p>
                            <div>
                ...
                <div className="contact" style={{ fontSize: 21 }}>
                    <Callout className="bp3-intent-success" style={{ height:'600px' }}>
                        <br /><br /><br />
                        <div style={{ display: 'inline', paddingLeft: '15%', fontSize: 21 }}>HSU Website:
                            <a href='http://hsusu.hk/' style={{ display: 'inline' }}>http://hsusu.hk/</a>
                            <span style={{ paddingLeft: '45%' }}></span>
                            <img style={{ position: 'absolute' }} src={'./HsuSu.png'} width='300' height='300' />
                        </div>
                        <br /><br /><br />
                            <div style={{ fontSize: 21, paddingLeft: '15%' }}>
